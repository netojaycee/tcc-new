        ...
        <div className="grid grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3">
          {displayCategories.map((category, index) => (
            ...
            >
              ...
              {/* Text overlay */}
              <div className="absolute inset-0 flex items-center justify-center px-2 text-center z-20">
                <span className=" text-background text-sm md:text-base leading-tight font-medium">
                  {category.title}
                </span>
              </div>
            </Link>
          ))}
          <div className="col-span-3 lg:col-span-2 flex flex-col items-start justify-center rounded bg-foreground px-4 py-4 md:px-5 md:py-5">
